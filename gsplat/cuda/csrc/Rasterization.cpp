...
std::tuple<at::Tensor, at::Tensor, at::Tensor> rasterize_to_pixels_3dgs_fwd_train(
    // Gaussian parameters
    const at::Tensor means2d,   // [C, N, 2] or [nnz, 2]
    const at::Tensor conics,    // [C, N, 3] or [nnz, 3]
    const at::Tensor colors,    // [C, N, channels] or [nnz, channels]
...
#define __LAUNCH_KERNEL_TRAIN__(N)                                             \
    case N:                                                                    \
        launch_rasterize_to_pixels_3dgs_fwd_train_kernel<N>(                   \
            means2d,                                                           \
            conics,                                                            \
            colors,                                                            \
            opacities,                                                         \
    ...
    switch (channels) {
        __LAUNCH_KERNEL_TRAIN__(1)
        __LAUNCH_KERNEL_TRAIN__(2)
        __LAUNCH_KERNEL_TRAIN__(3)
        __LAUNCH_KERNEL_TRAIN__(4)
        __LAUNCH_KERNEL_TRAIN__(5)
        __LAUNCH_KERNEL_TRAIN__(8)
        __LAUNCH_KERNEL_TRAIN__(9)
        __LAUNCH_KERNEL_TRAIN__(16)
        __LAUNCH_KERNEL_TRAIN__(17)
        __LAUNCH_KERNEL_TRAIN__(32)
        __LAUNCH_KERNEL_TRAIN__(33)
        __LAUNCH_KERNEL_TRAIN__(64)
        __LAUNCH_KERNEL_TRAIN__(65)
        __LAUNCH_KERNEL_TRAIN__(128)
        __LAUNCH_KERNEL_TRAIN__(129)
        __LAUNCH_KERNEL_TRAIN__(256)
        __LAUNCH_KERNEL_TRAIN__(257)
        __LAUNCH_KERNEL_TRAIN__(512)
        __LAUNCH_KERNEL_TRAIN__(513)
    default:
        AT_ERROR("Unsupported number of channels: ", channels);
    }
#undef __LAUNCH_KERNEL_TRAIN__
